-- Migration 004: Add Video Support
-- Run this migration on existing databases to add 'video' to the items type constraint
-- This is REQUIRED if you have an existing database and want to use video items
--
...
-- ALTER TABLE items DROP CONSTRAINT IF EXISTS items_type_check;
-- ALTER TABLE items ADD CONSTRAINT items_type_check CHECK (type IN ('book', 'podcast', 'music', 'podcast_episode'));
