...
const connectorUrl = `${baseUrl}/api/mcp/mcp`;

export const metadata: Metadata = {
  title: 'Connect Claude to Your Bookshelf — Virtual Bookshelf MCP Connector',
  description:
    'Manage your shelves from any Claude conversation. Add books, podcasts, and links, look up metadata, and share shelves — with the official Virtual Bookshelf MCP connector.',
  alternates: { canonical: '/claude' },
  openGraph: {
    title: 'Manage Your Bookshelf from Claude',
    description:
      'Say "add this book to my reading shelf" in Claude and it happens. Connect Claude to Virtual Bookshelf with one URL.',
    type: 'website',
    url: `${baseUrl}/claude`,
    siteName: 'Virtual Bookshelf',
    images: [{ url: `${baseUrl}/api/og/landing`, width: 1200, height: 630, alt: 'Virtual Bookshelf — Claude connector' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Manage Your Bookshelf from Claude',
    description: 'Connect Claude to Virtual Bookshelf with one URL and curate shelves by talking.',
...
const FAQ: FaqItem[] = [
  {
    q: 'What is the Virtual Bookshelf connector for Claude?',
    a: 'It is a remote MCP (Model Context Protocol) server that lets Claude read and manage your Virtual Bookshelf account. Once connected, you can list your shelves, add or remove books, podcasts, music, videos, and links, edit notes, and get share links — all by asking Claude in plain English.',
  },
  {
  ...
  {
    q: 'Does the connector work with Claude Code or the Claude API?',
    a: `Yes. In Claude Code run: claude mcp add --transport http bookshelf ${connectorUrl} — the same OAuth flow opens in your browser. The connector speaks standard MCP over Streamable HTTP, so any MCP-capable client can use it.`,
  },
  {
...
const jsonLd = [
  ...
  breadcrumbJsonLd([
    ...
    { name: 'Claude connector', url: `${baseUrl}/claude` },
  ]),
];

const EXAMPLE_PROMPTS = [
  {
    prompt: '“Add Project Hail Mary to my sci-fi shelf”',
    result: 'Claude finds the book on Google Books — cover, author, link — and shelves it.',
  },
  {
  ...
  {
    prompt: '“Make a shelf of the podcasts we just discussed and give me the link”',
    result: 'Claude creates the shelf, adds each show with real artwork, and returns the share URL.',
  },
];
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-20 pb-10 text-center">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center justify-center gap-1.5 text-sm text-gray-500 dark:text-gray-400">
              ...
              <li className="text-gray-700 dark:text-gray-300 font-medium">Claude connector</li>
            </ol>
          </nav>

          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-4 tracking-tight">
            Manage your bookshelf from Claude
          </h1>
          <p className="text-gray-600 dark:text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto">
            Connect once, then curate by talking. Add books mid-conversation, turn a discussion into a
            shareable shelf, or ask what&apos;s on your reading list — Claude handles the covers, links,
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="intro-heading" className="max-w-2xl mx-auto mb-16 sm:mb-20">
            <h2 id="intro-heading" className={`${h2Class} mb-4`}>
              How do you connect Claude to Virtual Bookshelf?
            </h2>
            <div className="space-y-4 text-gray-600 dark:text-gray-400 leading-relaxed">
              <p>
                Virtual Bookshelf ships an official MCP connector — a secure endpoint Claude can talk to.
                Add it as a custom connector in claude.ai (or Claude Code), approve access on
                virtualbookshelf.app, and every Claude conversation can read and manage your shelves.
                No password sharing, no copy-pasting lists.
              </p>
              ...
              {[
                {
                  ...
                  body: 'In claude.ai go to Settings → Connectors → Add custom connector and paste the connector URL above.',
                },
                {
                  n: 2,
                  title: 'Approve access',
                  body: 'Claude sends you to virtualbookshelf.app to sign in — including with Google — and approve. Claude never sees your password.',
                },
                {
                  n: 3,
                  title: 'Start talking',
                  body: 'Ask Claude what’s on your shelves or tell it to add something. It works in every conversation from then on.',
                },
              ].map((step) => (
